...
public interface CategorieApi {
    ...
    @GetMapping(value = APP_ROOT + "/categories/{id_categorie}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT + "/categories/filter/{nom}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = APP_ROOT + "/categories/delete/{id_categorie}")
