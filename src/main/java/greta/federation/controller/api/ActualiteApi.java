...
public interface ActualiteApi {
    ...
    @PostMapping(value = ADMIN_ENDPOINT + "/actualites/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = ADMIN_ENDPOINT + "/actualites/update/{id_actualite}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = ADMIN_ENDPOINT + "/actualites/{id_actualite}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT + "/actualites/filter/{titre}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT + "/actualites/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = ADMIN_ENDPOINT + "/actualites/delete/{id_actualite}")
