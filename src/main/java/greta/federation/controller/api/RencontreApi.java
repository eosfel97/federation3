...
public interface RencontreApi {
    ...
    @PostMapping(value = ADMIN_ENDPOINT + "/rencontres/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = ADMIN_ENDPOINT + "/rencontres/update/{id_rencontre}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = ADMIN_ENDPOINT + "/rencontres/{id_rencontre}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT + "/rencontres/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = ADMIN_ENDPOINT + "/rencontres/delete/{id_rencontre}")
