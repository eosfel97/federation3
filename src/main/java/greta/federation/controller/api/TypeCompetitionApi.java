...
public interface TypeCompetitionApi {
    ...
    @PostMapping(value = ADMIN_ENDPOINT + "/typecompetitions/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = ADMIN_ENDPOINT + "/typecompetitions/update/{id_typecompetition}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = ADMIN_ENDPOINT + "/typecompetitions/{id_typecompetition}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT + "/typecompetitions/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = ADMIN_ENDPOINT + "/typecompetitions/delete/{id_typecompetition}")
