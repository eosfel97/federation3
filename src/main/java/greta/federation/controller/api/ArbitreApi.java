...
public interface ArbitreApi {
    ...
    @PostMapping(value = ADMIN_ENDPOINT + "/arbitres/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value =ADMIN_ENDPOINT + "/arbitres/{id}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT +"/arbitres/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = ADMIN_ENDPOINT +"/arbitres/delete/{id}")
