...
public interface JoueurApi {
    ...
    @PostMapping(value = DIRECTEUR_ENDPOINT + "/joueurs/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = DIRECTEUR_ENDPOINT + "/joueurs/update/{id_joueur}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = ADMIN_ENDPOINT + "/joueurs/{id_joueur}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = APP_ROOT + "/joueurs/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = DIRECTEUR_ENDPOINT + "/joueurs/delete/{id_joueur}")
