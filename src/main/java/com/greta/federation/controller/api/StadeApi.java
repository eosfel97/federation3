...
public interface StadeApi {
    @PostMapping(value = Constants.DIRECTEUR_ENDPOINT + "/stades", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = Constants.DIRECTEUR_ENDPOINT + "/stades/{id_stade}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constants.APP_ROOT + "/stades/{nom}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constants.APP_ROOT + "/stades/ailes/{id_stade}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = Constants.ADMIN_ENDPOINT + "/stades/{id_stade}")
