...
public interface ArticleApi {
    @PostMapping(value = Constants.ADMIN_ENDPOINT + "/articles/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = Constants.ADMIN_ENDPOINT + "/articles/update/{id_article}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constants.ADMIN_ENDPOINT + "/articles/{id_article}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constants.APP_ROOT + "/articles/filter/{nom}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constants.APP_ROOT + "/articles/filter/category/{id_categorie}", produces = MediaType.APPLICATION_JSON_VALUE)
    List<ArticleDto> findAllArticleByIdCategorie(@PathVariable("id_categorie") Integer id_categorie);

    @GetMapping(value = Constants.APP_ROOT + "/articles/historique/commandeuser/{id_article}", produces = MediaType.APPLICATION_JSON_VALUE)
    List<LigneCommandeDto> findHistoriqueCommandeUser(@PathVariable("id_article") Integer id_article);

    @DeleteMapping(value = Constants.ADMIN_ENDPOINT + "/articles/delete/{id_article}")
