...
public interface ClubApi {
    ...
    @PostMapping(value = Constants.DIRECTEUR_ENDPOINT + "/clubs/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = Constants.DIRECTEUR_ENDPOINT + "/clubs/update/{id_club}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constants.ADMIN_ENDPOINT + "/clubs/{id_club}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constants.APP_ROOT + "/clubs/filter/{name}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = Constants.ADMIN_ENDPOINT + "/clubs/delete/{id_club}")
