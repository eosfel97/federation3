...
@Api("/categorie-football")
public interface CategorieFootballApi {

    @PostMapping(value = Constants.ADMIN_ENDPOINT+ "/categoriefootball/create", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @PutMapping(value = Constants.ADMIN_ENDPOINT+ "/categoriefootball/update/{id_categorie_football}", consumes = MediaType.APPLICATION_JSON_VALUE, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constants.ADMIN_ENDPOINT+ "/categoriefootball/{id_categorie_football}", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping(value = Constants.APP_ROOT+ "/categoriefootball/all", produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @DeleteMapping(value = Constants.ADMIN_ENDPOINT+"/categoriefootball/delete/{id_categorie_football}")
