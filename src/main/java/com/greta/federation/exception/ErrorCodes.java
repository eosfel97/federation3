...
public enum ErrorCodes {
    ...
    COMPETITION_NOT_VALID(7002),

    COMPETITION_NOT_FOUND(7003),
    TYPECOMPETITION_NOT_FOUND(7004),
    TYPECOMPETITION_NOT_VALID(7005),
    RENCONTRE_NOT_VALID(7006),
    RENCONTRE_NOT_FOUND(7007),
    EVENEMENT_RENCONTRE_NOT_FOUND(7008),
    EVENEMENT_RENCONTRE_NOT_VALID(7009),
    ...
    LIGNE_NOT_VALID(145002),
    LIGNE_NOT_FOUND(145003),
    AILE_NOT_VALID(145004),
    AILE_NOT_FOUND(145005);
